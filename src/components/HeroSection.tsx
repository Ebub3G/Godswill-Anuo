      ...
      <div className="container-section">
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
          <div className="animate-fade-in">
            <h1 className="text-4xl md:text-5xl font-normal mb-6 text-charcoal tracking-tight">
              Godswill Anuo
            </h1>
            <h2 className="text-lg md:text-xl mb-8 text-charcoal/70 font-light">
              Content Creator & Digital Designer
            </h2>
            <p className="text-charcoal/60 mb-12 max-w-lg mx-auto leading-relaxed">
